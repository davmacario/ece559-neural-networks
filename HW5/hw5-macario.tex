...
This homework activity revolved around the implementation of a neural network (NN) in Python using the PyTorch framework.
The task was the classification of a data set of images of 9 different classes of shapes: Circle, Square, Octagon, Heptagon, Nonagon, Star, Hexagon, Pentagon, Triangle.
The data set consisted of 10000 images per class, split in 8000 training and 2000 test samples.
